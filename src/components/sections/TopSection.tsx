  ...
  return (
    <section
      ...
      <div className="relative main-container z-10 text-center text-white">
        <img
          className="absolute top-16 left-0 md:left-24 opacity-30 md:opacity-100"
          src="/images/dc1.svg"
          alt="decoration 1"
        />
        <img
          className="absolute top-0 right-0 md:right-24 opacity-30 md:opacity-100"
          src="/images/dc2.svg"
          alt="decoration 2"
        />
        ...
        <div className="font-dm-sans flex items-center justify-center gap-6 md:gap-14 my-20">
          <a
            href="#features"
            className="px-6 md:px-10 py-4 md:py-6 bg-primary hover:saturate-200 transition duration-300 rounded-full font-bold shadow-2xl shadow-primary/30">
            Memulai Sekarang
          </a>
